...
|What problems have you encounter? If yes, how do you solve them?|I didn't find some problem.||Add the MIT license in the repo. I solve it when I put "License" at the name. After I follow the instruction and I could add the license.|remote compiling windows -> mac and achieve request under 1 sec for the furthest nodes.|I was really lost on the subject. My team try to explain me some point of requirements.|what we need to write on the functional, i saw the team 4|
|How do you feel at the end of the week? Why?|Very Great !||Happy but I'm tired|Really good, I make a big step in only 1 week for the project so I think I made my part for this week.|Tired because I really think a lot.|I'm tired|
|What do you think everyone could do to improve their performance, to work more effectively both as a group and as individuals? Try to give a global answer and an individual answer if necessary. All answers will be anonymous, unless you request otherwise.|Nothing really. All member work correctly at them rhythm and it's cool ! ||nothing|All member working effeciently, nothing to add.|I don't really know. maybe work more in team, because some work on their own side and at the end we know nothing about the product, the algorithm, how it work...|I think nothing|
|Finally, what are your goals for the upcoming week? How do you think you can achieve them?|Continues mines management documents and to manage my team.||Issues, template PR, advance in my test plan and start the programmation of test cases.|Polish the code and try to reduce needed memory for launching the program.|continue my technical until 35% and have an understanding of the project at 75%.|finish the functional, with my amazing brain|
